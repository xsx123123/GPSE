...
gpse train \
  ...
  --results_dir /data/jzhang/project/Temp/gpse_26.6.4_test/gpse_new_validation/6species/maize_FT_feature_selection_univariate/ \
...
gpse train \
  ...
  --target_trait FT \
  --task_type regression \
  --results_dir /data/jzhang/project/Temp/gpse_26.6.4_test/gpse_new_validation/6species/maize_FT_feature_selection_univariate_topsis/ \
  --models elasticnet_reg gbdt_reg svr_reg mlp_reg knn_reg rf_reg xgboost_reg adaboost_reg lightgbm_reg catboost_reg \
           kernelridge_reg gblup_reg histgradientboost_reg sgd_reg lasso_reg \
  --use_default_params \
  --test_size 0.3 \
